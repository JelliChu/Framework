...
public class Binding : Microsoft.UI.Xaml.Data.Binding, IOneWayMultibindingItem, IOneWayToSourceMultibindingItem
{
    ...
    private static bool CheckIfBindingModeIsValid(object source, string path, BindingMode mode)
    {
        ...
        return mode switch
        {
            BindingMode.OneTime or BindingMode.OneWay => sourceProperty.CanRead(),
            BindingMode.TwoWay => sourceProperty.CanRead() && sourceProperty.CanWrite(),
            _ => throw new ArgumentException("Unknown binding mode.", "mode"),
        };
    }
